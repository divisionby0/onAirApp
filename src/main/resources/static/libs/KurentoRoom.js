...
function Room(kurento, options) {
    ...
    this.onParticipantLeft = function (msg) {
        ...
        console.log("onParticipantLeft",msg);
    ...
    this.onIsOwnerStateChanged = function (msg) {
        console.log("Kurento room onIsOwnerStateChanged ",msg);
    };
...
function KurentoRoom(wsUri, callback) {
    ...
    function reconnectingCallback() {
        ...
        if (isRoomAvailable()) {
            ...
            alert('Reconnection error. Please reload page.');
        }
    }
