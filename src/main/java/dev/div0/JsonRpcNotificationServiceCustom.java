...
public class JsonRpcNotificationServiceCustom implements UserNotificationService {
    private static final Logger log = LoggerFactory.getLogger(JsonRpcNotificationServiceCustom.class);
    ...
    public void sendNotification(final String participantId, final String method, final Object params) {
        ...
        try {
            ...
            System.out.println("Exception sending notification '{}': {} to user id {} method="+ method+"  params="+params+"  participantId="+ participantId+"    e="+e);
        }
    }
